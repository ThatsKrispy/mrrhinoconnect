...
/* ── Dropdown ── */
.nav-dropdown{display:none;position:absolute;top:calc(100% + 10px);left:50%;transform:translateX(-50%);background:#fff;border:1px solid rgba(3,22,36,.09);border-radius:14px;box-shadow:0 20px 50px rgba(3,22,36,.12);z-index:1100;min-width:680px}
...
.dd-top{display:flex;align-items:center;justify-content:space-between;padding:.85rem 1.25rem;border-bottom:1px solid rgba(3,22,36,.07)}
.dd-top a{font-size:.76rem;font-weight:700;color:#031624;text-decoration:none;transition:color .15s}
.dd-top a:hover{color:#C8688F}
.dd-top span{font-size:.68rem;color:rgba(3,22,36,.4);font-weight:500}
.dd-body{display:grid;grid-template-columns:1fr 1fr;padding:.25rem 0 .5rem}
.dd-col{padding:.75rem 1.25rem}
.dd-col+.dd-col{border-left:1px solid rgba(3,22,36,.06)}
.dd-col-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:.6rem;padding-bottom:.5rem;border-bottom:1px solid rgba(3,22,36,.07)}
.dd-col-head span{font-size:.59rem;font-weight:700;letter-spacing:.15em;text-transform:uppercase;color:#C8688F}
.dd-col-head a{font-size:.7rem;font-weight:700;color:#031624;text-decoration:none;white-space:nowrap;transition:color .15s}
.dd-col-head a:hover{color:#C8688F}
.dd-group{margin-bottom:.65rem}
.dd-group:last-child{margin-bottom:0}
.dd-group-label{display:block;font-size:.58rem;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:rgba(3,22,36,.35);margin-bottom:.3rem;margin-top:.1rem}
.dd-col a{display:block;padding:.26rem 0;font-size:.77rem;color:rgba(3,22,36,.65);text-decoration:none;transition:color .13s,padding-left .12s;white-space:nowrap}
.dd-col a:hover{color:#C8688F;padding-left:3px}
    ...
    <nav class="nav-links" role="navigation" aria-label="Main navigation">
      ...
      <div class="nav-item">
        ...
        <div class="nav-dropdown" role="menu" aria-label="Solutions menu">
          <div class="dd-top">
            <span>19+ Technology Solutions</span>
            <a href="/services.html" role="menuitem">View All Solutions →</a>
          </div>
          <div class="dd-body">
            <!-- Real Estate column -->
            <div class="dd-col">
              <div class="dd-col-head">
                ...
                <a href="/real-estate.html" role="menuitem">All RE Solutions →</a>
              </div>
              <div class="dd-group">
                <span class="dd-group-label">Networking &amp; Connectivity</span>
                ...
                <a href="/services/das.html" role="menuitem">DAS Solutions</a>
                <a href="/services/iptv.html" role="menuitem">IPTV Services</a>
              ...
              <div class="dd-group">
                <span class="dd-group-label">Surveillance &amp; Security</span>
                ...
                <a href="/services/iot-sensors-beacons.html" role="menuitem">IoT Sensors &amp; Beacons</a>
              </div>
              <div class="dd-group">
                <span class="dd-group-label">Smart Building Systems</span>
            ...
            <div class="dd-col">
              <div class="dd-col-head">
                <span>Education</span>
                <a href="/education.html" role="menuitem">All EDU Solutions →</a>
              </div>
              <div class="dd-group">
                <span class="dd-group-label">Cybersecurity</span>
                <a href="/services/cybersecurity.html" role="menuitem">Cybersecurity Solutions</a>
              </div>
              <div class="dd-group">
                <span class="dd-group-label">Business Continuity</span>
