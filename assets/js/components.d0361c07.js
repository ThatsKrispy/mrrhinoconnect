...
<header class="site-header" role="banner">
...
</header>`;lectrical Cabling</a><a href="/services/das.html"role="menuitem">Distributed Antenna System</a></div><div class="dropdown-group"><span class="dropdown-label">Surveillance&amp;Security</span><a href="/services/cctv-security-cameras.html"role="menuitem">CCTV&amp;Security Cameras</a><a href="/services/mobile-security-trailer.html"role="menuitem">Mobile Security Trailer</a><a href="/services/iot-sensors-beacons.html"role="menuitem">IoT Sensors and Beacons</a></div><div class="dropdown-group"><span class="dropdown-label">Smart Building Systems</span><a href="/services/smart-buildings.html"role="menuitem">Smart Buildings</a><a href="/services/solar-panels.html"role="menuitem">Solar Panels</a><a href="/services/hvac.html"role="menuitem">HVAC</a><a href="/services/ev-charging-stations.html"role="menuitem">EV Charging Stations</a><a href="/services/digital-signage.html"role="menuitem">Digital Signage</a><a href="/services/led-lighting.html"role="menuitem">LED Lighting</a><a href="/services/air-quality-control.html"role="menuitem">Air Quality Control</a></div></div></div><div class="nav-item"><a href="/faq.html"class="nav-link">FAQ</a></div><div class="nav-item"><a href="/news.html"class="nav-link">News</a></div><div class="nav-item"><a href="/contact.html"class="nav-link">Contact</a></div></div><!--Desktop CTA--><div class="nav-cta"><a href="tel:+13052491084"class="nav-phone"aria-label="Call MrRhinoConnect at 305.249.1084"><svg width="14"height="14"viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2"aria-hidden="true"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 10a19.79 19.79 0 01-3.07-8.67A2 2 0 012 .84h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.09 8.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z"/></svg>305.249.1084</a><a href="/contact.html"class="nav-call-btn">Get Started</a></div><!--Hamburger--><button class="nav-toggle"id="nav-toggle"aria-label="Open navigation menu"aria-expanded="false"aria-controls="nav-drawer"><span aria-hidden="true"></span><span aria-hidden="true"></span><span aria-hidden="true"></span></button></div></header>`;
  /* ── ACTIVE NAV ─────────────────────────────────── */
  ...
  drawer.addEventListener('keydown', e => {
    ...
    /* ── CONSENT BANNER ──────────────────────────────── */
  const CONSENT_HTML = `<div class="consent-banner"id="consent-banner"role="dialog"aria-modal="true"aria-label="Cookie consent"aria-describedby="consent-desc"><div class="consent-inner"><div class="consent-text"><p id="consent-desc">We use cookies to enhance your experience and analyze site traffic.<a href="/privacy-policy.html">Privacy Policy</a></p></div><div class="consent-actions"><button class="consent-accept"id="consent-accept">Accept All</button><button class="consent-decline"id="consent-decline">Decline</button></div></div></div>`;

  /* ── ADA ACCESSIBILITY WIDGET ────────────────────── */
  const A11Y_HTML = `<div id="ada-widget-wrap"><button
id="ada-trigger"
aria-label="Open accessibility menu"
aria-expanded="false"
aria-controls="ada-panel"
aria-haspopup="dialog"
title="Accessibility Options"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="1.8"aria-hidden="true"focusable="false"><circle cx="12"cy="5"r="2"/><path d="M12 7v5M8 9h8M9 22l1.5-5h3L15 22"/></svg><span class="ada-trigger-label"aria-hidden="true">Accessibility</span></button><div
id="ada-panel"
role="dialog"
aria-label="Accessibility settings"
aria-modal="false"
hidden><div class="ada-panel-header"><span>Accessibility Options</span><button id="ada-close"aria-label="Close accessibility menu"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2.5"aria-hidden="true"focusable="false"><line x1="18"y1="6"x2="6"y2="18"/><line x1="6"y1="6"x2="18"y2="18"/></svg></button></div><div class="ada-section-label"id="ada-sec-content">Content</div><div class="ada-options"role="group"aria-labelledby="ada-sec-content"><div class="ada-option-row"id="ada-row-fontsize"><span class="ada-option-label"id="ada-lbl-fontsize">Text Size</span><div class="ada-stepper"role="group"aria-labelledby="ada-lbl-fontsize"><button class="ada-step-btn"id="ada-font-dec"aria-label="Decrease text size"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2.5"aria-hidden="true"focusable="false"><line x1="5"y1="12"x2="19"y2="12"/></svg></button><span class="ada-step-val"id="ada-font-val"aria-live="polite"aria-atomic="true">100%</span><button class="ada-step-btn"id="ada-font-inc"aria-label="Increase text size"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2.5"aria-hidden="true"focusable="false"><line x1="12"y1="5"x2="12"y2="19"/><line x1="5"y1="12"x2="19"y2="12"/></svg></button></div></div><div class="ada-option-row"id="ada-row-spacing"><span class="ada-option-label"id="ada-lbl-spacing">Letter Spacing</span><div class="ada-stepper"role="group"aria-labelledby="ada-lbl-spacing"><button class="ada-step-btn"id="ada-space-dec"aria-label="Decrease letter spacing"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2.5"aria-hidden="true"focusable="false"><line x1="5"y1="12"x2="19"y2="12"/></svg></button><span class="ada-step-val"id="ada-space-val"aria-live="polite"aria-atomic="true">Normal</span><button class="ada-step-btn"id="ada-space-inc"aria-label="Increase letter spacing"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2.5"aria-hidden="true"focusable="false"><line x1="12"y1="5"x2="12"y2="19"/><line x1="5"y1="12"x2="19"y2="12"/></svg></button></div></div><button class="ada-toggle-btn"id="ada-dyslexia"aria-pressed="false"><span class="ada-toggle-icon"aria-hidden="true"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2"aria-hidden="true"focusable="false"><path d="M4 7V4h16v3M9 20h6M12 4v16"/></svg></span><span>Dyslexia Font</span><span class="ada-toggle-status"aria-hidden="true">Off</span></button><button class="ada-toggle-btn"id="ada-linespacing"aria-pressed="false"><span class="ada-toggle-icon"aria-hidden="true"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2"aria-hidden="true"focusable="false"><line x1="3"y1="6"x2="21"y2="6"/><line x1="3"y1="12"x2="21"y2="12"/><line x1="3"y1="18"x2="21"y2="18"/></svg></span><span>Increase Line Height</span><span class="ada-toggle-status"aria-hidden="true">Off</span></button></div><div class="ada-section-label"id="ada-sec-visual">Visual</div><div class="ada-options"role="group"aria-labelledby="ada-sec-visual"><button class="ada-toggle-btn"id="ada-contrast"aria-pressed="false"><span class="ada-toggle-icon"aria-hidden="true"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2"aria-hidden="true"focusable="false"><circle cx="12"cy="12"r="10"/><path d="M12 2a10 10 0 010 20z"fill="currentColor"stroke="none"/></svg></span><span>High Contrast</span><span class="ada-toggle-status"aria-hidden="true">Off</span></button><button class="ada-toggle-btn"id="ada-invert"aria-pressed="false"><span class="ada-toggle-icon"aria-hidden="true"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2"aria-hidden="true"focusable="false"><circle cx="12"cy="12"r="10"/><path d="M12 2a10 10 0 000 20z"fill="currentColor"stroke="none"/></svg></span><span>Dark/Invert Colors</span><span class="ada-toggle-status"aria-hidden="true">Off</span></button><button class="ada-toggle-btn"id="ada-grayscale"aria-pressed="false"><span class="ada-toggle-icon"aria-hidden="true"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2"aria-hidden="true"focusable="false"><rect x="3"y="3"width="18"height="18"rx="2"/><path d="M3 12h18"stroke-width="2"/><path d="M3 3h18v9H3z"fill="currentColor"stroke="none"opacity=".4"/></svg></span><span>Grayscale</span><span class="ada-toggle-status"aria-hidden="true">Off</span></button><button class="ada-toggle-btn"id="ada-saturation"aria-pressed="false"><span class="ada-toggle-icon"aria-hidden="true"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2"aria-hidden="true"focusable="false"><path d="M12 2v20M2 12h20"stroke-width="2"/><circle cx="12"cy="12"r="6"fill="currentColor"opacity=".25"/></svg></span><span>Low Saturation</span><span class="ada-toggle-status"aria-hidden="true">Off</span></button></div><div class="ada-section-label"id="ada-sec-nav">Navigation</div><div class="ada-options"role="group"aria-labelledby="ada-sec-nav"><button class="ada-toggle-btn"id="ada-links"aria-pressed="false"><span class="ada-toggle-icon"aria-hidden="true"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2"aria-hidden="true"focusable="false"><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/></svg></span><span>Highlight Links</span><span class="ada-toggle-status"aria-hidden="true">Off</span></button><button class="ada-toggle-btn"id="ada-focus"aria-pressed="false"><span class="ada-toggle-icon"aria-hidden="true"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2"aria-hidden="true"focusable="false"><rect x="3"y="3"width="18"height="18"rx="2"stroke-width="2.5"/><rect x="8"y="8"width="8"height="8"rx="1"/></svg></span><span>Enhanced Focus Ring</span><span class="ada-toggle-status"aria-hidden="true">Off</span></button><button class="ada-toggle-btn"id="ada-animations"aria-pressed="false"><span class="ada-toggle-icon"aria-hidden="true"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2"aria-hidden="true"focusable="false"><circle cx="12"cy="12"r="10"/><line x1="4.93"y1="4.93"x2="19.07"y2="19.07"/></svg></span><span>Pause Animations</span><span class="ada-toggle-status"aria-hidden="true">Off</span></button></div><button class="ada-reset-btn"id="ada-reset"aria-label="Reset all accessibility settings to default"><svg viewBox="0 0 24 24"fill="none"stroke="currentColor"stroke-width="2"aria-hidden="true"focusable="false"><path d="M3 12a9 9 0 109-9H3"/><polyline points="3 3 3 12 12 12"/></svg>Reset All Settings</button><div class="ada-footer-note"><a href="https://www.w3.org/WAI/standards-guidelines/wcag/"target="_blank"rel="noopener noreferrer">WCAG 2.1 AA</a>accessibility tools</div></div></div>`;
  ...
  function loadDyslexiaFont() {
    ...
    st.textContent = `body.ada-dyslexia,body.ada-dyslexia*{font-family:"Comic Sans MS","Comic Sans",cursive!important;word-spacing:0.16em!important;}`;
